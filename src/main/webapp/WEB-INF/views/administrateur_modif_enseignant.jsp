...
<body>
	...
	<div class="mainContent">
		...
		<br /> <br />
		<h1>Formulaire de modification d'un enseignant</h1>
				...
				<c:forEach
					...
					<tr>
						...
						<td>Promotion : <form:select class="custom-select"
								...
								<option
									value="${enseignantMatierePromotion.promotion.idPromotion}">${enseignantMatierePromotion.promotion.libelle}</option>
								<c:forEach items="${enseignantform.listePromotionsExistantes }"
									var="promotion">
