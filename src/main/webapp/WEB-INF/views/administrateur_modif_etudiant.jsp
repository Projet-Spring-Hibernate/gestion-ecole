...
<title>Admin - modifier etudiant</title>
<body>
	...
	<div class="mainContent">
		...
		<form:form modelAttribute="etudiantForm" method="POST"
			action="${pageContext.request.contextPath}/etudiants/update">

			<%-- 			<form:errors path="*" cssClass="error_validation" element="div"/> --%>
			<form:hidden path="etudiant.identifiant" />
			<form:hidden path="etudiant.motdepasse" />
				...
				<tr>
					...
					<td><c:forEach
							...
							<form:checkbox path="listeIdPromotions"
								value="${promotion.idPromotion}" label=" ${promotion.libelle}" />
							<br />
						</c:forEach></td>
