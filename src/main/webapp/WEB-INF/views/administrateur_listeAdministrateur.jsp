...
<body>
	...
	<table class="table table-striped">
		...
		<c:forEach items="${attribut_liste_administrateur}" var="administrateur">
			<tr>
				...
				<td><a href="${pageContext.request.contextPath}/administrateurs/afficher/${administrateur.identifiant}">Afficher</a></td>
