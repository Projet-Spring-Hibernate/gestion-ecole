...
<title>Admin - ajouter administrateur</title>
<body>
	...
	<div class="mainContent">
		...
		<br /> <br />
		<h1>Formulaire d'ajout d'un administrateur</h1>
		...
		<form:form modelAttribute="administrateurForm" method="POST"
			...
			<table class="table">
				...
				<tr>
					<td><form:label path="administrateur.motdepasse">Mot de passe :</form:label></td>
					<td><form:input path="administrateur.motdepasse" /></td>
					<td><form:errors path="administrateur.motdepasse" /></td>
				</tr>
