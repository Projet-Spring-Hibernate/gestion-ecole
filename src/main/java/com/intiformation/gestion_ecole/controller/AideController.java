...
public class AideController {
	...
	/**
	 * Permet de recuperer la liste de toutes les aides. Invoqué au click du
	 * bouton "Aides" de l'entête admin. Renvoie vers la page
	 * administrateur_ListeAides.jsp
	 * 
	 * @param modele
	 * @return
	 */
	...
	// ===========================================================//
	/**
	 * Permet d'afficher les caractéristiques d'une aide. Invoqué au click du
	 * bouton "Afficher" de la  page administrateur_listeAides. Renvoie vers la page
	 * affichage_aide.jsp
	 * 
	 * @param pId_aide
	 ...
	 * Invoqué au click du bouton "Modifier" de la page affichage_aide.jsp.
	 * <br/>
